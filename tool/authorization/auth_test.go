...
//	aa := NewAAA[AccessClaims, UserSession](store.NewLocalStore(10), &AccessClaims{}, &UserSession{})
//	ctx, err := aa.AuthorizationFromHeader(context.Background(), "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NzMwNDE0NzMsImlhdCI6MTc3MzAzNzg3MywiaWQiOjEsIm5hbWUiOiJ0ZXN0In0.J6c9ZkoIzSKLTTpQfVFVEUmMYt5-ILalo_OhlXSMCow")
//	if err != nil {
//		t.Error(err)
//		return
//	}
