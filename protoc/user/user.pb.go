...
type RequestHello struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name" form:"name" xml:"name"`  
	Age           int32                  `protobuf:"varint,2,opt,name=age,proto3" json:"age" form:"age" xml:"age"`   
...
type ResponseHello struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Str           string                 `protobuf:"bytes,1,opt,name=str,proto3" json:"str" form:"str" xml:"age"`  
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
