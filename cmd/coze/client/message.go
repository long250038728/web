...
func (c *Client) ConversationsMessageCreate(ctx context.Context, request *ConversationsMessageCreateRequest) (*Message, error) {
	...
	resp, err := coze.NewCozeAPI(coze.NewJWTAuth(oauth, nil), coze.WithBaseURL(coze.CnBaseURL)).Conversations.Messages.Create(ctx, req)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ConversationsMessageList(ctx context.Context, request *ConversationsMessageListRequest) (*ConversationsMessageListResponse, error) {
	...
	resp, err := coze.NewCozeAPI(coze.NewJWTAuth(oauth, nil), coze.WithBaseURL(coze.CnBaseURL)).Conversations.Messages.List(ctx, req)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ConversationsMessageRetrieve(ctx context.Context, request *ConversationsMessageRetrieveRequest) (*coze.RetrieveConversationsMessagesResp, error) {
	...
	resp, err := coze.NewCozeAPI(coze.NewJWTAuth(oauth, nil), coze.WithBaseURL(coze.CnBaseURL)).Conversations.Messages.Retrieve(ctx, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
